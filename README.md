...
## **Your new self-hosted library you can try with no risk.**<br>[See the features that will make you keep it for good.](https://seamus-sloan.github.io/omnibus/)
...
| [**Deploy on Kubernetes**](charts/omnibus/README.md) | Helm chart: single-replica/SQLite constraints, volumes, ingress, CSRF origin |
