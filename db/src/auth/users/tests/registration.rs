//! Account creation: the first user becomes admin and closes
//! registration, later users need it open, case-insensitive username
//! collisions and invalid names are rejected, the first-user race elects
//! one admin, a failed create rolls back cleanly, and promotion is
//! idempotent.
