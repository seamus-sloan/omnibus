//! `replace_books` and the reindex path it drives: metadata + cover
//! insertion, accent-color validation, atomic replacement, override
//! survival, the contributor blocklist, and the author/series/FTS
//! bookkeeping a full reindex maintains.
