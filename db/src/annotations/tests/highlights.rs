//! The web-path highlight CRUD: create round trip and `BookNotFound`,
//! listing isolated by user and book with its hard cap and covering-index
//! plan, color and note updates, delete, the `NotFound` variants for
//! another user's row, and the DB-failure path.
