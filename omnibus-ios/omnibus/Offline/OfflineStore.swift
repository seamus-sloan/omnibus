...
actor OfflineStore {
    ...
    /// The newest queued op of one kind, held-aside rows included — a restore
    /// reading the outbox wants this device's last statement of the value,
    /// and the server having refused it doesn't change what it said.
