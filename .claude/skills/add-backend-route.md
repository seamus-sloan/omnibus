...
See [add-playwright-flow.md](add-playwright-flow.md). Add a new spec under `ui_tests/playwright/tests/flows/` with one layout test + action tests (happy + error paths).
