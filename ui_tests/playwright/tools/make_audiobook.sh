#!/usr/bin/env bash
# Provenance: how the public-domain M4B fixture was produced.
#
# This script is NOT required for CI — the M4B is committed as-is under
# test_data/audiobooks/public_domain/. It exists only to document the
# conversion so a future maintainer can reproduce or update it.
#
