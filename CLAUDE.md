...
- [11-position-and-spoilers.md](.claude/rules/11-position-and-spoilers.md) — reporting where a reader is (resolved server-side, confidence is part of the answer, an audio part is not a chapter) and what they may be shown ("can't tell" is never "safe").
